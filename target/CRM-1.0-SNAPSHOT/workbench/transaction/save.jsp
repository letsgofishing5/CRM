...
<body>
	...
	<form class="form-horizontal" id="tranForm" action="workbench/transaction/saveTran.do" method="post" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control timeDown" readonly id="create-expectedClosingDate" name="expectedDate">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="沙发11">
				<input type="hidden"name="activityId" value="0308bf8b98dc49a18474d624fba4233e" id="hidden-activitySrc">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="contactsId" id="hidden-contactsName" value="334cc14d43674a3f9fcad5dd03588a53">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control timeTop" readonly id="create-nextContactTime" name="nextContactTime">
			</div>
		</div>
